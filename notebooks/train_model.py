...
test_size=0.2,
# 20% pour le test
#Random state permet de faire la séparation de manière aléatoire mais reproductible
random_state=42,
...
# Creer le modele
#Random Forest : ensemble de plusieurs arbres de decision
...
comparison = pd.DataFrame({
    # Afficher les 10 premiers diagnostics reelles et les predictions correspondantes
